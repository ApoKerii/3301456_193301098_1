...
import 'package:pexels_app/Servis/ImagePick.dart';

import 'package:pexels_app/Servis/KayitMetotlari.dart';
                    ...
                    onPressed: ()async{ 
                      if(email.text.isEmpty && password.text.isEmpty){
                        showDialog(context: context, builder:(context,){
                          return const AlertDialog(content: Text("Lütfen email ve şifre alanlarını doldurunuz"),);
                        });
                      }
                      else{
                        if(nullableimage==null){
                          print(nullableimage);
                          ByteData resimverisi=await rootBundle.load("assets/images/personimage.jpg");
